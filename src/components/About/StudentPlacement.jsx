...
const StudentPlacement = () => (
  <div>
    <Helmet>
      ...
      <meta name='description' content='Tallaght Rehabilitation Project always welcome people wishing to volunteer their time here at Kiltalown House and Tallaght Rehabilitation Project and can provide appropriate training and support for interested volunteers.' />
    </Helmet>
