...
const EducationalIntervention = () => (
  <div>
    <Helmet>
      ...
      <meta name='description' content='The education component of the programme is designed to be learner focused and provides short modules relevant in content to the needs of the group.' />
    </Helmet>
