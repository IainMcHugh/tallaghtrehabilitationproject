        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Tallaght Rehabilitation Project CLG,
              Kiltalown House, Jobstown, Dublin 24.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Tallaght Rehabilitation
              ...
              <a
                ...
                target="_blank"
              >
                http://www.tallaghtrehabproject.ie/
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            ...
            <a
              ...
              target="_blank"
            >
              http://www.tallaghtrehabproject.ie/contact
            </a>
          </li>
        </ul>
      </PrivacyPolicyWrapper>
